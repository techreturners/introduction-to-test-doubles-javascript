...
const createOrderRequest = (bubbleTeaRequest) => {
    ...
    const { paymentDetails: {name, address, debitCard: {digits}, bubbleTea: {type}},  } = bubbleTeaRequest;
    ...
    logMessage(`The following Bubble Tea Order Request has been created  ${JSON.stringify(orderRequest)}`);
